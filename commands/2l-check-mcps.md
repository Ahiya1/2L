...
**Prerequisites:** Database running on port 54322
...
To configure MCPs in Claude Code CLI:

1. **Navigate to your project directory**
2. **Create/edit configuration file:** `.mcp.json` in project root
3. **Add MCP server configurations** for the MCPs you want
4. **Exit and restart Claude Code CLI session** to activate MCPs (exit → claude code)

For detailed setup instructions for each MCP, follow the setup links above.

### Configuration Location

- **All platforms:** `.mcp.json` in your project directory (e.g., `~/your-project/.mcp.json`)
...
echo "2. Create/edit .mcp.json in project root"
echo "3. Add MCP server configurations"
echo "4. Exit and restart Claude Code CLI session"
echo ""
